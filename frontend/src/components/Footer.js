...
export default function Footer() {
  ...
  return (
    <div className='bg-gradient-to-r from-gray-400 to-gray-600 text-white p-10'>
        <div className='flex flex-col sm:flex-row flex-wrap justify-around items-center sm:items-start text-center sm:text-left gap-8 cursor-pointer'>
            ...
            <ul className='flex flex-col gap-2 text-xs sm:text-sm'>
                ...
                <li>Eventbrite Demo</li>
                <li>Eventbrite Webinars</li>
        ...
        <div className='flex flex-row-reverse flex-wrap lg:flex-nowrap gap-12 justify-evenly items-center pt-20 lg:px-10'>
