  ...
  return (
    <Router>
      <div className="relative min-h-100 lg:flex bg-gray-100">
          ...
          {/* Sidebar */}
          <div className={`sidebar lg:min-h-screen lg:sticky lg:top-0 space-y-6 text-white px-2 ${ width < breakpoint ? "bg-gray-600 absolute top-15 min-w-full z-[100]" : "bg-gradient-to-l from-blue-300 to-blue-600 text-lg pt-8 w-[240px]"}
