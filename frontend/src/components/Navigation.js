  ...
  return (
    <Router>
      <div className="relative min-h-100 lg:flex bg-gray-100">
          ...
          {/* Sidebar */}
          <div className={`sidebar lg:min-h-screen lg:fixed lg:top-0 space-y-6 text-white px-2 ${ width < breakpoint ? "bg-gray-600 absolute top-15 min-w-full z-[100]" : "bg-gradient-to-l from-blue-300 to-blue-600 text-lg pt-8 w-[240px]"}
          transform-translate-x-full lg:relative lg:translate-x-0 transition duration-200 ease-in-out`}>
            { width > breakpoint && (
              <>
                <Link to="/" className="block min-w-[400px] text-2xl font-extrabold text-white space-x-3 px-4 pr-4">
                ...
                <nav className="px-4">
                  <Link to={"/"} className="text-white block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-500">
                    Home
                  </Link>
                  ...
                  {!user.data && <>
                  <Link to={"/login"} className="text-white block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-500">
                    Login
                  </Link>
                  <Link to={"/register"} className="text-white block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-500">
                    Signup
                  </Link>
                  </>
                  }
                  { user?.data && <>
                    <Link to={"/account"} className="text-white block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-500" >
                      Account
                    </Link>
                    <Link to={"/messenger"} className="text-white block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-500" >
                      Messenger
                    </Link>
      ...
      <div  className='h-[2px] w-full bg-gray-800/50 px-8'/>
      <Footer/>
    </Router>
  );
}
